namespace Eco.Mods.TechTree
{
    ...
    public partial class GrasslandSaladKitchenRecipe : RecipeFamily
    {
        public GrasslandSaladKitchenRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "GrasslandSaladKitchen",  //noloc
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(GrasslandSaladKitchenRecipe), start: 4, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Grassland Salad"), recipeType: typeof(GrasslandSaladKitchenRecipe));
