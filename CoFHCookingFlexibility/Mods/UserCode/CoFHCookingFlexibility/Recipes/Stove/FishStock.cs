namespace Eco.Mods.TechTree
{
    ...
    public partial class FishStockStoveRecipe : RecipeFamily
    {
        public FishStockStoveRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FishStockStoveRecipe), start: 8, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Fish Stock"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fish Stock"), recipeType: typeof(FishStockStoveRecipe));
