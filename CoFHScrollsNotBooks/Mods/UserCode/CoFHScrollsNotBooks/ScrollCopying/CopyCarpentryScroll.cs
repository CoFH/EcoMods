namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyCarpentryRecipe : RecipeFamily
    {
        public SkillScrollCopyCarpentryRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyCarpentry",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Carpentry)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyCarpentryRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Carpentry)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Carpentry)"), recipeType: typeof(SkillScrollCopyCarpentryRecipe));
