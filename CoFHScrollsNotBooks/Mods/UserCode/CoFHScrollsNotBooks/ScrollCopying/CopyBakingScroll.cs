namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyBakingRecipe : RecipeFamily
    {
        public SkillScrollCopyBakingRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyBaking",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Baking)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyBakingRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Baking)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Baking)"), recipeType: typeof(SkillScrollCopyBakingRecipe));
