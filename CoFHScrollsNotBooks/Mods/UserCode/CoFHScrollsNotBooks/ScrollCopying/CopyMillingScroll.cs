namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyMillingRecipe : RecipeFamily
    {
        public SkillScrollCopyMillingRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyMilling",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Milling)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyMillingRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Milling)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Milling)"), recipeType: typeof(SkillScrollCopyMillingRecipe));
