namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopySmeltingRecipe : RecipeFamily
    {
        public SkillScrollCopySmeltingRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopySmelting",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Smelting)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopySmeltingRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Smelting)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Smelting)"), recipeType: typeof(SkillScrollCopySmeltingRecipe));
