namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyButcheryRecipe : RecipeFamily
    {
        public SkillScrollCopyButcheryRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyButchery",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Butchery)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyButcheryRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Butchery)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Butchery)"), recipeType: typeof(SkillScrollCopyButcheryRecipe));
