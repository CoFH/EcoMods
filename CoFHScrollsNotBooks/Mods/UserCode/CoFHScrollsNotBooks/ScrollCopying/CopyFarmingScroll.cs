namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyFarmingRecipe : RecipeFamily
    {
        public SkillScrollCopyFarmingRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyFarming",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Farming)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyFarmingRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Farming)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Farming)"), recipeType: typeof(SkillScrollCopyFarmingRecipe));
