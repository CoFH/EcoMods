namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyMasonryRecipe : RecipeFamily
    {
        public SkillScrollCopyMasonryRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyMasonry",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Masonry)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyMasonryRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Masonry)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Masonry)"), recipeType: typeof(SkillScrollCopyMasonryRecipe));
