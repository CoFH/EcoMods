namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyMechanicsRecipe : RecipeFamily
    {
        public SkillScrollCopyMechanicsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyMechanics",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Mechanics)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyMechanicsRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Mechanics)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Mechanics)"), recipeType: typeof(SkillScrollCopyMechanicsRecipe));
