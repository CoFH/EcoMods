namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyTailoringRecipe : RecipeFamily
    {
        public SkillScrollCopyTailoringRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyTailoring",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Tailoring)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyTailoringRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Tailoring)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Tailoring)"), recipeType: typeof(SkillScrollCopyTailoringRecipe));
