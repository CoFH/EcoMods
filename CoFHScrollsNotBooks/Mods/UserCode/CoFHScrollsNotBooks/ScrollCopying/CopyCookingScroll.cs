namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyCookingRecipe : RecipeFamily
    {
        public SkillScrollCopyCookingRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyCooking",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Cooking)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyCookingRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Cooking)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Cooking)"), recipeType: typeof(SkillScrollCopyCookingRecipe));
