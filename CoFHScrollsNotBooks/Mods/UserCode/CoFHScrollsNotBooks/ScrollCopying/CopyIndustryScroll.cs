namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyIndustryRecipe : RecipeFamily
    {
        public SkillScrollCopyIndustryRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyIndustry",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Industry)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyIndustryRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Industry)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Industry)"), recipeType: typeof(SkillScrollCopyIndustryRecipe));
