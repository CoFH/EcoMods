namespace Eco.Mods.TechTree
{
    ...
    public partial class SkillScrollCopyPotteryRecipe : RecipeFamily
    {
        public SkillScrollCopyPotteryRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SkillScrollCopyPottery",  //noloc
                displayName: Localizer.DoStr("Skill Scroll Copy (Pottery)"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SkillScrollCopyPotteryRecipe), start: 2f, skillType: typeof(PaperMillingSkill), typeof(PaperMillingFocusedSpeedTalent), typeof(PaperMillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skill Scroll Copy (Pottery)"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Skill Scroll Copy (Pottery)"), recipeType: typeof(SkillScrollCopyPotteryRecipe));
