...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RefrigeratorUnlinkedObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(RefrigeratorUnlinkedItem);
        public override LocString DisplayName => Localizer.DoStr("Refrigerator (Unlinked)");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = RefrigeratorUnlinkedItem.homeValue;
    ...
    [Serialized]
    [LocDisplayName("Refrigerator (Unlinked)")]
    ...
    public partial class RefrigeratorUnlinkedItem : WorldObjectItem<RefrigeratorUnlinkedObject>
    {
        ...
        {
            ObjectName                              = typeof(RefrigeratorUnlinkedObject).UILink(),
        ...
        static RefrigeratorUnlinkedItem()
        {
            WorldObject.AddOccupancy<RefrigeratorUnlinkedObject>(new List<BlockOccupancy>(){
