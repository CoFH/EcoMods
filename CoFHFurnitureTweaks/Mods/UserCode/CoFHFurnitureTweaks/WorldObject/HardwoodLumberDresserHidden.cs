...
namespace Eco.Mods.TechTree
{
    ...
    public partial class HardwoodLumberDresserHiddenObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(HardwoodLumberDresserHiddenItem);
        public override LocString DisplayName => Localizer.DoStr("Hardwood Lumber Dresser (Hidden)");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = HardwoodLumberDresserHiddenItem.homeValue;
    ...
    [Serialized]
    [LocDisplayName("Hardwood Lumber Dresser (Hidden)")]
    ...
    public partial class HardwoodLumberDresserHiddenItem : WorldObjectItem<HardwoodLumberDresserHiddenObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(HardwoodLumberDresserHiddenObject).UILink(),
        ...
        static HardwoodLumberDresserHiddenItem()
        {
            WorldObject.AddOccupancy<HardwoodLumberDresserHiddenObject>(new List<BlockOccupancy>(){
