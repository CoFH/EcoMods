namespace Eco.Mods.TechTree
{
    ...
    public partial class RecycleModernToolRecipe : RecipeFamily
    {
        public RecycleModernToolRecipe()
        {
            ...
            recipe.Init(
                name: "RecycleModernTool",  //noloc
                displayName: Localizer.DoStr("Recycle Modern Tool"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("ModernTool", 1)
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RecycleModernToolRecipe), start: 0.25f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
