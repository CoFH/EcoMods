namespace Eco.Mods.TechTree
{
    ...
    public partial class RecycleStoneToolRecipe : RecipeFamily
    {
        public RecycleStoneToolRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "RecycleStoneTool",  //noloc
                displayName: Localizer.DoStr("Recycle Stone Tool"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("StoneTool", 1)
                },
            ...
            this.Initialize(displayText: Localizer.DoStr("Recycle Stone Tool"), recipeType: typeof(RecycleStoneToolRecipe));
